...
from tkinter import ttk, simpledialog, messagebox, Scrollbar
import pyttsx3
...
def handle_text_input():
    ...
    if query:
        ...
        if result:
            ...
            result_text.config(state=tk.NORMAL)
            result_text.delete("1.0", tk.END)
            result_text.insert(tk.END, "Sorry, I couldn't find an answer to your question or a related one.")
            result_text.config(state=tk.DISABLED)
    else:
...
frame.pack(pady=20, anchor="center")  # Center the frame
...
# Create result text widget and scrollbar
result_frame = tk.Frame(root)
result_frame.pack(fill="both", expand=True, padx=20, pady=20, anchor="center")  # Center the result frame

result_text = tk.Text(result_frame, font=("TimesNewRoman", 15), wrap="word", bg="#f0f0f0")
...
recognizer = init_speech_recognition("C:/Users/manid/Desktop/drdl/main project files/vosk-model-small-en-us-0.15")  # Replace with the actual path to the Vosk model directory
